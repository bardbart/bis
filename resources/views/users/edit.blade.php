                ...
                <div class="card-body"> --}}
                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" placeholder="example@gmail.com" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required autocomplete="email">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="permissions" multiple="multiple" class="custom-select custom-select-md mb-3">
